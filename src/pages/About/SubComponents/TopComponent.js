            ...
            <Container className='d-md-flex d-block align-items-center'>
                <Row>
                    <Col md="10" className='mx-auto text-center'>
                        ...
                        Coachmie is a technology company that builds learning infrastructure for the internet community. Learners at different career stages use our infrastructure to schedule and make payments for sessions with experts online in order to get into tech, build tech products and conduct research anywhere. Coachmie is registered in the United States, United Kingdom and Nigeria.
